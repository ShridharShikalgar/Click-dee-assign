    ...
    <div>
        ...
        <div className={Styles.CongoMSG}>
            ...
            <div className={Styles.slogan}>
                <span>You pre-qualify for $2,500 Flex Card plus $0 cost Vision & Dental coverage.</span>
                <span>Call us now to secure your possible additional benefits & flex card.</span>
            </div>
            <button className={Styles.btn}>
                <img src='https://cdn-icons-png.flaticon.com/128/2948/2948005.png' alt='not found'/>
                <span className={Styles.number}>866-951-5443</span></button>
